...
import categoryImage from '../../public/img/categories/category-1.jpg';
import categoryImage2 from '../../public/img/categories/category-2.jpg';
import categoryImage3 from '../../public/img/categories/category-3.jpg';
import categoryImage4 from '../../public/img/categories/category-4.jpg';
import categoryImage5 from '../../public/img/categories/category-5.jpg';
...
import instagram from '../../public/img/instagram/insta-1.jpg'
import instagram2 from '../../public/img/instagram/insta-2.jpg'
import instagram3 from '../../public/img/instagram/insta-3.jpg'
import instagram4 from '../../public/img/instagram/insta-4.jpg'
import instagram5 from '../../public/img/instagram/insta-5.jpg'
import instagram6 from '../../public/img/instagram/insta-6.jpg'
                            ...
                            banners.map((ban, index) => (
                                <div class="col-lg-6 p-0">
                                    <div class="categories__item categories__large__item set-bg"
                                        style={{ backgroundImage: `url(${ban.bannerImg})` }}
                                    // data-setbg="../public/img/categories/category-1.jpg"
                                    >
                                        <div class="categories__text">
                                            <h1>{ban.bannerTitle}</h1>
                                            <p>{parse(ban.bannerDis)}</p>
                                            <a href="#">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                                    <div class="categories__item set-bg"
                                        ...
                                        style={{ backgroundImage: `url(${categoryImage2})` }}
                                    >
                                        <div class="categories__text">
                                            <h4>Men’s fashion</h4>
                                            <p>358 items</p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                                    <div class="categories__item set-bg"
                                        ...
                                        style={{ backgroundImage: `url(${categoryImage4})` }}
                                    >
                                        <div class="categories__text">
                                            <h4>Cosmetics</h4>
                                            <p>159 items</p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                                    <div class="categories__item set-bg"
                                        ...
                                        style={{ backgroundImage: `url(${categoryImage5})` }}
                                    >
                                        <div class="categories__text">
                                            <h4>Accessories</h4>
                                            <p>792 items</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="trend__content">
                                ...
                                <div class="trend__item">
                                    <div class="trend__item__pic">
                                        <img src="../../public/img/trend/bs-2.jpg" alt="" />
                                    </div>
                                    <div class="trend__item__text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="trend__content">
                                ...
                                <div class="trend__item">
                                    <div class="trend__item__pic">
                                        <img src="public/img/trend/f-1.jpg" alt="" />
                                    </div>
                                    <div class="trend__item__text">
